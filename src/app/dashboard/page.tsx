  ...
  if (workspaces.length === 0) {
    return (
      <div className="flex h-full flex-col items-center justify-center py-24 text-center">
        <div className="rounded-2xl border border-dashed border-gray-300 px-12 py-16 max-w-md dark:border-gray-700">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-50 dark:bg-indigo-950">
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Create your first workspace</h2>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
        ...
        <ul className="mt-4 space-y-3">
          ...
          {allProjects.length === 0 && (
            <li className="text-sm text-gray-400 dark:text-gray-500">No projects yet</li>
          )}
        </ul>
      </div>
    </div>
